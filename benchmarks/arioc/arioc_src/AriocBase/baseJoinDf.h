...
*/
#pragma once
#define __baseJoinDf__

/// <summary>
/// Class <c>baseJoinDf</c> identifies candidates for paired-end alignment
/// </summary>
class baseJoinDf : public tuBaseS, public CudaLaunchCommon
{
    private:
        QBatch*                 m_pqb;
        AriocBase*              m_pab;
    ...
    public:
        baseJoinDf( const char* ptumKey, QBatch* pqb );
        virtual ~baseJoinDf( void );
};
