...
/// <summary>
/// Class <c>baseFilterD</c> flags concordantly-mapped pairs as non-candidates for subsequent windowed gapped alignment
/// </summary>
class baseFilterD : public tuBaseS, public CudaLaunchCommon
{
    ...
    public:
        baseFilterD( const char* ptumKey, QBatch* pqb, DeviceBuffersBase* pdbb, RiFlags flagRi, INT16 At );
