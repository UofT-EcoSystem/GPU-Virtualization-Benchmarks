...
void usage_hotspot3d(int argc, char **argv)
{
...
int main_hotspot3d(int argc, char** argv, int uid, cudaStream_t & stream)
{
    ...
    hotspot_opt1(powerIn, tempIn, tempOut, numCols, numRows, layers, Cap, Rx, Ry, Rz, dt,iterations,uid,stream);
